...
async function setup() {
  await Lead.create([
    ...
    { leadId: `${P}dup1`, Company: 'Dup One', Country: 'France', Email: 'a@dup-test.fr', stage: 'contacted' },
    { leadId: `${P}dup2`, Company: 'Dup Two', Country: 'France', Email: 'b@dup-test.fr', stage: 'contacted' },
    // 도메인 유일 — 담당자가 바뀐 경우를 잡아야 한다
    { leadId: `${P}solo`, Company: 'Solo Ltd', Country: 'Poland', Email: 'old@solo-test.pl', stage: 'contacted' },
